...
var TreeView = function (_Component) {
  ...
  _createClass(TreeView, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery2.default)(_reactDom2.default.findDOMNode(this)).on('changed.jstree', function (e, data) {
        if (_this2.props.onChanged) {
          _this2.props.onChanged(data.selected.map(function (item) {
